...
export class HeaderLayoutComponent implements OnInit {
  ...
  isHideChangePassword:boolean = false;
  isEnableUsername:boolean = true;
  ...
  rolesValidation() {
    ...
    let isActive_genesys_users = typeof (this.permissionsHeaders.settings.users) != 'undefined' ? (this.permissionsHeaders.settings.users.isView || this.permissionsHeaders.settings.users.isViewEdit) : false;
    ...
    if (this.permissionsHeaders.settings.platformSettings.isView || this.permissionsHeaders.settings.preferences.isView || this.permissionsHeaders.settings.roles.isView || this.permissionsHeaders.settings.topicDetection.isView || this.permissionsHeaders.settings.users.isView
      || this.permissionsHeaders.settings.platformSettings.isViewEdit || this.permissionsHeaders.settings.preferences.isViewEdit || this.permissionsHeaders.settings.roles.isViewEdit || this.permissionsHeaders.settings.users.isViewEdit || this.permissionsHeaders.settings.topicDetection.isViewEdit || isActive_dataPartition || isActive_genesys_users) {
  ...
  validateTopHeader() {
    ...
    this.router.events.subscribe((event) => {
      ...
      if (event instanceof NavigationEnd) {
        ...
        if (rUrl == '/home/home-dashboard' || rUrl == '/home/customize-dashboard' || rUrl == '/home/help' || rUrl == '/home/command-center') {
        ...
        else if (rUrl == '/settings/platform-setting' || rUrl == '/settings/preferences' || rUrl == '/settings/partitions' || rUrl == '/settings/roles' || rUrl == '/settings/genesys-users' || rUrl == '/settings/topic-detection') {
          ...
          else if (rUrl == '/settings/genesys-users') {
